        ...
        {items.map((item, idx) => (
          <li
            ...
            <blockquote>
              ...
              <span
                className="relative z-20 text-sm leading-[1.6] text-gray-100 font-normal capitalize">
                {item.reviewText}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span className=" text-sm leading-[1.6] text-gray-400 font-normal capitalize">
                    {item.collegeId?.name}
                  </span>
                  <span className=" text-sm leading-[1.6] text-gray-400 font-normal capitalize">
                    {item.userId?.name}
